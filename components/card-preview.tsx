  ...
  ({ card }, ref) => {
    ...
    const fontStyle = (() => {
      switch (card.font) {
        ...
        case 'amarante':
          return 'font-amarante';
        default:
          return 'font-eb-garamond'; // Default font
      }
    })();
    ...
    if (card.layout === 'back') {
      ...
      return (
        <div>
          <div ref={ref}>
            <div
              className={`w-[295px] h-[430px] flex flex-col gap-2 overflow-hidden box-content ${styles.textColor} relative`}
            >
              ...
              <div className="absolute inset-0 z-0">
                ...
                />
                <div
                  className={`absolute inset-0 ${styles.tint} mix-blend-multiply`}
                ></div>
                {texture.watermark && (
                  <div className="absolute inset-0 z-0">
                    <Image
