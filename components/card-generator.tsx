...
import { Download, Edit, GalleryThumbnailsIcon as Gallery, PlusCircle, Save } from "lucide-react"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
            ...
            <div className="flex gap-4 mt-6">
              ...
              <Button variant={"secondary"} onClick={createNewCard} className="flex-1">
